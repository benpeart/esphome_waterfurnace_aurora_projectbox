...
//
//  This is a box for WaterFurnace Aurora ESPHome
//
...
cutoutsBase = 
[
      [pcbLength/2, pcbWidth/2 ,45, 43, 0, yappPolygon, shapeHexagon, maskHoneycomb, yappCenter, yappCoordPCB]
];
...
snapJoins   =   
[
    [pcbLength/4, 8, yappLeft, yappRight]
   ,[pcbLength-(pcbLength/4+4), 8, yappLeft, yappRight]
];
